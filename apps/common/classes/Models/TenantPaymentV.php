...
class TenantPaymentV extends \Phalcon\Mvc\Model
{
     ...
     *
     * @var string
     * @Column(type="string", length=91, nullable=true)
     */
    ...
    /**
     * Method to set the value of field tenant_name
     *
    ...
    /**
     * Returns the value of field tenant_name
     *
     * @return string
     */
